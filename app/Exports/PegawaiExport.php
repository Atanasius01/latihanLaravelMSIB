...
class PegawaiExport implements FromCollection, WithHeadings
{
    ...
    */
    public function collection()
    {
        ...
        ->select('pegawai.nip','pegawai.nama','pegawai.gender', 'jabatan.nama as jabatan', 'divisi.nama as divisi', 'pegawai.tmp_lahir', 'pegawai.tgl_lahir', 'pegawai.kekayaan', 'alamat')
        ->get();
        return $ar_pegawai;
    }
